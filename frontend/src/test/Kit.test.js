...
// searchBox.props().onChange( {target: {name: 'search-box', value: "Star Wars"} } );//type in the text to search
// await searchButton.props().onClick();//click the button and wait for it to complete (but not reallly waiting, but kind of)
